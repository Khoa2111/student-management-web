<nav class="navbar">
    ...
    <ul class="navbar-menu" id="navbarMenu">
        ...
        <li><a href="<?php echo SITE_URL; ?>/dashboard.php"<?php echo ($currentFile === 'dashboard.php') ? ' class="active"' : ''; ?>>Lớp của tôi</a></li>
        <?php elseif ($userRole === 'student'): ?>
        <li><a href="<?php echo SITE_URL; ?>/dashboard.php"<?php echo ($currentFile === 'dashboard.php') ? ' class="active"' : ''; ?>>Thông tin của tôi</a></li>
        <?php endif; ?>
